...
badd +0 srcs/wordpress/Dockerfile
...
badd +0 srcs/mysql/srcs/entrypoint_mysql.sh
badd +0 srcs/wordpress/srcs/entrypoint_wp.sh
badd +0 setup.sh
badd +0 srcs/nginx/Dockerfile
badd +0 srcs/nginx/srcs/csejault.conf
badd +18 srcs/nginx/srcs/nginx_entrypoint.sh
badd +0 srcs/nginx/srcs/entrypoint_nginx.sh
argglobal
silent! argdel *
$argadd srcs/mysql/Dockerfile
set stal=2
edit srcs/mysql/srcs/entrypoint_mysql.sh
...
exe 'vert 1resize ' . ((&columns * 182 + 182) / 364)
exe 'vert 2resize ' . ((&columns * 181 + 182) / 364)
tabedit srcs/nginx/srcs/csejault.conf
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
119
normal! zo
let s:l = 119 - ((70 * winheight(0) + 40) / 81)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
119
normal! 05|
tabedit srcs/wordpress/srcs/entrypoint_wp.sh
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 39 - ((38 * winheight(0) + 40) / 81)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
