...
badd +1 ../ft_server/srcs/config_files/config.inc.php
badd +1 ../ft_server/Dockerfile
badd +177 ~/.vimrc
badd +1 srcs/phpmyadmin/srcs/entrypoint_pma.sh
badd +1 srcs/phpmyadmin/srcs/config.inc.php
badd +1 ../ft_server/srcs/scripts/init_mariadb.sh
...
badd +0 srcs/nginx.yaml
badd +0 srcs/wordpress.yaml
badd +0 srcs/phpmyadmin.yaml
badd +0 todo
badd +1 srcs/nginx/srcs/nginx.pem
badd +0 srcs/nginx/srcs/nginx_key.pem
badd +0 ../ft_server/srcs/config_files/nginx_phpmyadmin
badd +0 srcs/configmap.yaml
...
badd +0 srcs/wordpress/srcs/wp-config.php
argglobal
silent! argdel *
...
wincmd w
argglobal
if bufexists('../ft_server/srcs/config_files/nginx_phpmyadmin') | buffer ../ft_server/srcs/config_files/nginx_phpmyadmin | else | edit ../ft_server/srcs/config_files/nginx_phpmyadmin | endif
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 50 - ((34 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 43 - ((27 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 88 - ((29 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 65 - ((4 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
...
247
normal! zo
let s:l = 243 - ((72 * winheight(0) + 40) / 81)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
243
